...
class LoadResult{
public:
	LoadResult() : status(SUCCESFUL){}
	LoadResult(loadStatus s) : status(s){}
	void addMessage(std::string s){messages.push_back(s);}
	const std::vector<std::string>& getWarnings() const {return messages;}
